                        ...
                        <div class="login-box">
                            ...
                            <div class="login-space">
                                <div class="login">
                                    ...
                                    <div class="group"> <input id="check" type="checkbox" class="check" checked name="keepSignedIn"> <label for="check"><span class="icon"></span> Keep me Signed in</label> </div>
                                ...
                                <div class="sign-up-form">
                                    ...
                                    <div class="group"> <label for="email" class="label">Email Address</label> <input id="email" type="text" class="input" placeholder="Enter your email address" name="email"> </div>
