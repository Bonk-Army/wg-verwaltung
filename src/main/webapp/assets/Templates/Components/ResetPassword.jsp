<div class="text-center">
    <form method="POST" action="resetComplete" class="form-signin">
        ...
        <input type="text" id="inputPW" class="form-control" placeholder="New Password" autofocus="autofocus" name="password">
        <label for="inputPW2" class="sr-only">Password Repeat</label>
        <input type="text" id="inputPW2" class="form-control" placeholder="New Password repeat">
